...
//extrai o ultimo termo adicionado
	...
	//adiciona a tag de input com a especializaxao no html
	function addEspecializacao(titulo) {
		$('#listaEspecializacoes')
			.append('<input type="hidden" value="'+ titulo +'" name="especialidades">');
	}
//exibe na pagina um toast com msg dee especilidade repetidas
	...
	$("#autocomplete-especialidades")
		...
		.autocomplete({
			...
			search : function() {
				// custom min de caracter para consultar
			...
			select : function(event, ui) {
				//o que tem no componente de input
